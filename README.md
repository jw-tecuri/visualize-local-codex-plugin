...
Visualize Local packages the `$visualize-local` skill for Codex. It creates theme-aware, self-contained HTML visualizations in a private hidden temp directory and returns a friendly file link, without writing generated demos into the active project workspace.
